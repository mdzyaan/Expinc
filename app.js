...
var budgetController = (function() {
    ...
    return {
        addItem: function(type, description, value) {
            ...
            // create the object based on 'inc' or 'exp'
            if (type === 'exp') {
            ...
            // Add object to budget controller
...
var UIController = (function(){
    ...
    return {
        ...
        displayDate: function() {
            ...
            month = now.getMonth();
            document.querySelector(DOMString.dateLabe).textContent = monthList[month] + ' of ' + year;
        },
        changedType: function() {
            ...
            console.log('clicked')
            document.querySelector(DOMString.inputAdd__btn).classList.toggle('red');
        },
        test: function() {
...
var controller = (function(budgetCtrl,UICtrl){
    ...
    var setupEventListener = function() {
        ...
        document.querySelector(DOM.inputAdd__btn).addEventListener('click', ctrlAddItem);
    ...
    var ctrlAddItem = function() {
        ...
        if ( input.description !== "" && !isNaN(input.value)  && input.value > 0) {
            ...
            updateBudget();
            // 6. Update and display the percentage
            updatePercentage();
        }
    };
    ...
    var ctrlDeleteItem = function(event) {
        ...
        if (itemID) {
            ...
            updateBudget();
            // 4. Update and display the percentage
            updatePercentage();
        }
    }
    return {
